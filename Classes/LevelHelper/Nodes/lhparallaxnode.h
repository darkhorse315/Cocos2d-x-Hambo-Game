...
public:
	...
	LHParallaxPointObject(CCPoint _ratio);
};

class LHParallaxNode : public CCNode//CCParallaxNode 
{
public:
	bool isContinuous;
	int direction;
	...
	CCArray* spritesInNode();
	CCArray* bodiesInNode();
	void setPosition(CCPoint pos,LHParallaxPointObject* point);
	void repositionPoint(LHParallaxPointObject* point);
	void visit();
	
	LHParallaxNode(CCDictionary* parallaxDict);
};