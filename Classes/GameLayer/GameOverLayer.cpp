...
void GameOverLayer::createButtons()
{
	...
	menuMainmenu->setPosition(ccp(iDevPixelX(522), SCREEN_HEIGHT - iDevPixelY(487)));    
	...
	menuSolution->setPosition(ccp(iDevPixelX(715), SCREEN_HEIGHT - iDevPixelY(487)));    
	...
	menuShop->setPosition(ccp(iDevPixelX(326), SCREEN_HEIGHT - iDevPixelY(487)));    
	addChild(menuShop);
	...
	menuSkip->setPosition(ccp(iDevPixelX(666), SCREEN_HEIGHT - iDevPixelY(576)));    
	addChild(menuSkip);
